                    ...
                    <div class="section_content">
                        <div class="tasks">
                            ...
                            <?php 
                                ...
                                if($page>1){
                                    echo "<a href='admin_completed.php?page=".($page-1)."' class='btn btn-danger'>Previous</a>";
                                }

                                for($i=1;$i<$total_page;$i++){
                                    echo "<a href='admin_completed.php?page=".$i."' class='btn btn-primary'>$i</a>";
                                }
                                if($page>0 && $page<$total_page){
                                    echo "<a href='admin_completed.php?page=".($page+1)."' class='btn btn-danger'>Next</a>";
                                }
